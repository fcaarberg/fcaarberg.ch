...
$languageFile = 'lng_german.php';         // Choose the language file
...
$cfgServerUser = 'fcaarberg';             // MySQL user
$cfgServerPassword = 'DwLMJ9W9';          // MySQL password

$cfgDbDatabase = 'fcaarberg';             // MySQL database name containing phpSecurePages table
