...
if ( version_compare( '4.3', phpversion(), '>' ) ) {
	die( 'Dein Server l&auml;uft mit der PHP-Version ' . phpversion() . ', WordPress ben&ouml;tigt aber mindestens Version 4.3.' );
}

if ( !extension_loaded('mysql') && !file_exists(ABSPATH . 'wp-content/db.php') )
	die( 'Deine PHP-Installation scheint nicht &uuml;ber MySQL zu verf&uuml;gen.' );
...
if ( is_wp_error($prefix) )
	wp_die('<strong>FEHLER</strong>: <code>$table_prefix</code> in  der Datei <code>wp-config.php</code> darf nur Nummern, Buchstaben und Unterstriche enthalten.');
